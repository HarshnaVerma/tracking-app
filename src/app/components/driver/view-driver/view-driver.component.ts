...
export class ViewDriverComponent implements OnInit {
  ...
  constructor(private configService: ConfigService, private backendApiService: BackendApiService,
              ...
              private dialog: MatDialog, private dialogRef: MatDialogRef<ViewDriverComponent>,
  ...
  openImageModalRowDescription(imgIndex: number) {
    ...
    const index: number = ViewDriverComponent.getCurrentIndexCustomLayout(this.imagesRect[imgIndex], this.imagesRect);
